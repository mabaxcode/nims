...
var KTChartsWidget15 = {
    init: function() {
        const fetchData = async () => {
            try {
                const response = await fetch(base_url + '/app/statistic_nurse'); // Replace with your API endpoint
                if (!response.ok) {
        ...
        !async function() {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    const data = await fetchData(); // Fetch the data from the server
                    if (data.length === 0) return; // Exit if no data

                    // Calculate maximum value from the data
                    ...
                    var t, a = function() {
                        ...
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, {
                            renderer: am5xy.AxisRendererY.new(t, {}),
                            min: 0, // Minimum value
                            max: maxValue + 10 // Add padding to maximum value
                        }));
                        o.get("renderer").grid.template.setAll({
                            stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),
                            strokeWidth: 1,
                        ...
                        i.columns.template.setAll({
                            ...
                            cornerRadiusBL: 0,
                            cornerRadiusTL: 6
                        }), i.data.setAll(data), i.appear(), a.appear(1e3, 100)
                    };
                    am5.ready((function() {
                        a()
                    })), KTThemeMode.on("kt.thememode.change", (function() {
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        fetch(base_url + 'app/statistic_nurse')  // This is where your PHP endpoint is
                            ...
                            .then(l => {
                                ...
                                i.columns.template.setAll({
								    tooltipText: "{categoryX}: {valueY.formatNumber('#')}", // Tooltip shows integer values
								    tooltipY: 0,
								    strokeOpacity: 0,
								    templateField: "columnSettings",
								    cornerRadiusBR: 0,
