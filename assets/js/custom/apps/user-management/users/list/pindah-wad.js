...
var validateFormTukarSister;
function validateTukarSister(formID)
{   
    const folderFormWad = document.getElementById(formID);
    // Init form validation rules. For more info check the FormValidation plugin's official documentation:https://formvalidation.io/
    validateFormTukarSister = FormValidation.formValidation(
    folderFormWad,
    {
        fields: {
            wad: {
...
$(document).on('click', '.tukar-wad-nurse', function (e) {
    // e.preventDefault();
    // validateFormTukarSister.validate().then(function(status) {
	e.preventDefault();
    validateFormTukarSister.validate().then(function(status) {

        if (status == 'Valid') {

            var fileFormData = $('#form_tukar_sister').serialize();

            $.ajax({
                url: base_url + 'setting/doTukarWad',
                type: "POST",
                data: fileFormData,
                dataType: "json",
                async: true,
