												...
												<div class="card-body">
													...
													<div id="kt_user_view_details" class="collapse show">
														<div class="pb-5 fs-6">
															...
															<div class="text-gray-600">24 Jun 2024, 6:05 pm</div>
															<!--begin::Details item-->
														</div>
													</div>
													<!--end::Details content-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/customer/c_6678224f31cab/not_found</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_3298_7145/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/customer/c_6678224f31cac/not_found</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_8970_2495/invalid</td>
																			<td class="pe-0 text-end min-w-200px">15 Apr 2024, 10:30 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	...
																	<tr>
																		...
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2024, 9:23 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Brian Cox</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#OLP-45690</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2024, 6:05 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
