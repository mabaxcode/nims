...
<html lang="en">
	...
	<head>
		...
		<meta name="keywords" content="tailwind, tailwindcss, metronic, bootstrap, bootstrap 5, angular, VueJs, React, Asp.Net Core, Rails, Spring, Blazor, Django, Express.js, Node.js, Flask, Symfony & Laravel starter kits, admin themes, web design, figma, web development, free templates, free admin themes, bootstrap theme, bootstrap template, bootstrap ontactboard, bootstrap dak mode, bootstrap button, bootstrap datepicker, bootstrap timepicker, fullcalendar, datatables, flaticon" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Metronic - The World's #1 Selling Tailwind CSSontact & Bootstrap Admin Template by KeenThemes" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<? $this->load->view('app/table-senarai-semua-jawatan'); ?>
						<!--end::Content wrapper-->
						<!--begin::Footer-->
		...
		<script src="<?= base_url(); ?>assets/js/custom/apps/user-management/users/list/add-jawatan.js"></script>
		...
		<script type="text/javascript">
			...
			$(document).on('click', '.edit-jawatan', function(e){
				var id = $(this).data('init');
			    e.preventDefault();
			    $.ajax({
			        url: base_url + 'setting/editJawatan',
			        type: "POST",
			        data: {id:id},
			        async: true,
			...
			$(document).on('click', '.hapus-jawatan', function(e){
			    var id = $(this).data('init');
			    e.preventDefault();
			    Swal.fire({
			      // title: "Are you sure?",
			      text: "Hapuskan Jawatan ?",
			      icon: "warning",
			      ...
			      if (result.isConfirmed) {
			        ...
			        // });
			        $.ajax({
			            url: base_url + 'setting/hapusJawatan',
			            type: "POST",
			            data: {id:id},
			            async: true,
			            dataType:"json",
