                ...
                <div class="row g-5 g-xl-10">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="modal fade" id="kt_modal_add_wad" tabindex="-1" aria-hidden="true">
                                <!--begin::Modal dialog-->
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-5 my-7">
                                            ...
                                            <!--begin::Form-->
                                            <form id="kt_modal_add_wad_form" class="form" action="#">
                                                ...
                                                <div class="text-center pt-10">
                                                    <button type="reset" class="btn btn-light me-3" onclick="$('#kt_modal_add_wad').modal('hide');">Batal</button>
                                                    <button type="submit" class="btn btn-primary add-new-wad" data-kt-users-modal-action="submit">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0);" class="menu-link px-3 edit-wad" data-init="<?=$key['id']?>">Kemaskini</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0);" class="menu-link px-3 hapus-wad" data-init="<?=$key['id']?>">Hapuskan</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <!-- <div class="menu-item px-3">
