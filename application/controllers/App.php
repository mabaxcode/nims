...
class App extends CI_Controller {
	...
	{	
		...
		if ($check == true) {
			...
			$update = array('no_ic' => $post['no_ic'], 'umur' => $post['umur'], 'bangsa' => $post['bangsa']);
		...
		$update_user = array('name' => $post['name'], 'email' => $post['email']);
	...
	function simpanMaklumatKontak($data=false)
	{
		...
		$update = array('email' => $post['email'], 'phone_no' => $post['phone_no']);
